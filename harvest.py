...
def Api_connect():
    Api_Id="AIzaSyBLr1Kd6ZqZeIR0p5KBeFbQgyiijqYk_ME"
...
# Upload to MongoDB
client=pymongo.MongoClient("mongodb+srv://jerommrtn:jerommartin@jerommartin.gdvhn8w.mongodb.net/?retryWrites=true&w=majority&appName=Jerommartin")
